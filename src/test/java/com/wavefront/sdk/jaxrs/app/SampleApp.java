package com.wavefront.sdk.jaxrs.app;
...
import com.wavefront.sdk.jaxrs.WavefrontJaxrsFilter;
...
public class SampleApp extends Application<Configuration> {
  ...
  public void run(Configuration configuration, Environment environment) {
    ...
    environment.jersey().register(new WavefrontJaxrsFilter.Builder(new SdkReporter() {
      @Override
      ...
      public void stop() {
        ...
        customTags(new HashMap<String, String>() {{
          put("location", "SF");
          put("env", "Staging");
        }}).build()).withTracer(new WavefrontTracer.Builder().build(new Reporter() {
      @Override
