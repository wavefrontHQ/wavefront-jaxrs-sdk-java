...
public class SampleApp extends Application<Configuration> {
  ...
  public void run(Configuration configuration, Environment environment) {
    ...
    environment.jersey().register(new WavefrontJaxrsServerFilter.Builder(new SdkReporter() {
      @Override
  ...
  public class SampleResource {
    ...
    // R => multiple path arguments
    @GET
    @Path("/bar/{id}/{subId}/{id}")
    public String getMultiplePathArgs() {
      return "don't care";
    }
