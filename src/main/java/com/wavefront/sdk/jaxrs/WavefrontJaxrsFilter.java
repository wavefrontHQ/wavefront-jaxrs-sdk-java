 ...
 */
public class WavefrontJaxrsFilter implements ContainerRequestFilter, ContainerResponseFilter {
  ...
  private final String PROPERTY_NAME = "com.wavefront.sdk.jaxrs.internal.SpanWrapper" +
      ".activeSpanWrapper";
  @Nullable
  ...
  private WavefrontJaxrsFilter(SdkReporter wfJaxrsReporter, ApplicationTags applicationTags,
  ...
  public static final class Builder {
    ...
    public WavefrontJaxrsFilter build() {
      return new WavefrontJaxrsFilter(wfJaxrsReporter, applicationTags, tracer);
    }
  ...
  public void filter(ContainerRequestContext containerRequestContext) throws IOException {
    if (containerRequestContext != null) {
      ...
      Optional<Pair<String, String>> optionalPair = MetricNameUtils.metricNameAndPath(
  ...
  public void filter(ContainerRequestContext containerRequestContext,
    ...
    if (containerRequestContext != null) {
      ...
      Optional<Pair<String, String>> requestOptionalPair = MetricNameUtils.
          metricNameAndPath(containerRequestContext);
