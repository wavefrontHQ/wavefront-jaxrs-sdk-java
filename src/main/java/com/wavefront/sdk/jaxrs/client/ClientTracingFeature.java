...
public class ClientTracingFeature implements Feature {
   ...
   *
   * By default get's operation name is HTTP method and get is decorated with {@link
   * ClientSpanDecorator#STANDARD_TAGS} which adds set of standard tags.
   */
  public static class Builder {
    ...
    /**
     * @param priority the overriding priority for the registered component. Default is {@link
    ...
    /**
     * @param serializationPriority the overriding priority for the registered component. Default is
     *                              {@link Priorities#ENTITY_CODER}
     * @return builder
     * @see Priorities
     */
